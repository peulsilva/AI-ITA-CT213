...
class RoombaBehaviorTree(BehaviorTree):
    ...
    def __init__(self):
        ...
        self.selector_node=SelectorNode("SelectorNode")
        self.sequence_node1=SequenceNode("SequenceNode1")
        self.sequence_node2=SequenceNode("SequenceNode2")
        self.move_forward_node=MoveForwardNode()
        self.move_in_spiral_node=MoveInSpiralNode()
        self.go_back_node=GoBackNode()
        self.rotate_node=RotateNode()

        self.root=self.selector_node

        self.selector_node.add_child(self.sequence_node1)
        self.selector_node.add_child(self.sequence_node2)
        self.sequence_node1.add_child(self.move_forward_node)
        self.sequence_node1.add_child(self.move_in_spiral_node)
        self.sequence_node2.add_child(self.go_back_node)
        self.sequence_node2.add_child(self.rotate_node)
