...
def make_lenet5():
    ...
    model.add(layers.Conv2D(filters=16, kernel_size=(5,5),activation=activations.tanh))
    model.add(layers.AveragePooling2D(pool_size=(2,2),strides=(2,2)))
    model.add(layers.Conv2D(filters=120, kernel_size=(5, 5), activation=activations.tanh))
